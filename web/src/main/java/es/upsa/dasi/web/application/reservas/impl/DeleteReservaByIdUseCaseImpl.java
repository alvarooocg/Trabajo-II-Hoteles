...
import es.upsa.dasi.web.application.reservas.DeleteReservaByIdUseCase;
...
@ApplicationScoped
public class DeleteReservaByIdUseCaseImpl implements DeleteReservaByIdUseCase
{
    @Inject
    @RestClient
    ...
    {
        restClient.deleteReservaById(id);
    }
}
