...
public class ReservasResponseExceptionMapper implements ResponseExceptionMapper<WebApplicationException>
{
    @Override
    public WebApplicationException toThrowable(Response response)
    {
        ...
        {
            case NOT_FOUND -> new ReservaNotFoundRuntimeException();
